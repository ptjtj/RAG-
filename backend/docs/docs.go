...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.DashboardStatsData"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "models.DashboardStatsData": {
            "type": "object",
            "properties": {
                "costTrend": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DailyTokenStat"
                    }
                },
                "todayChats": {
                    "type": "integer",
        ...
        "models.UpdateSessionRequest": {
            ...
            "properties": {
                ...
                "title": {
                    "description": "使用指针类型 (*string, *bool)：区分前端是传了空值/false，还是根本没传。",
                    "type": "string",
                    "example": "新的会话标题"
                }
            }
